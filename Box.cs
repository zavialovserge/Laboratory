                            ...
                            for (int j = 0; j < setWidth; j++)
                            {
                                ...
                                else if (i >= 1 && i < (setHeight-1))
                                {
                                    if (j == 0 || j == (setWidth-1))
                                    {
                                        ...
                                        {
                                            Console.SetCursorPosition(setX + (setWidth - message.Length) / 2, setY + setHeight / 2);
                                            Console.Write(setSymbol);
                                            if (message == null)
                                            { 
                                                message = ""; 
                                            }
                                            else if (message.Length > (setWidth - 1))
                                            {
                                                string mess=message.Remove((message.Length-(setWidth-1)));
                                                Console.Write(mess);
                                            }
                                            else
                                            {
